...
The project was generated using the [Dream.Architecture.Solution.Template](caRepositoryUrl) version caPackageVersion.
...
```bash
dotnet new install Dream.Architecture.Solution.Template::caPackageVersion
```
